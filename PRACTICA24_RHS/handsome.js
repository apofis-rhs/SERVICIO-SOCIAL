...
function actualizarContadores(datosTabla) {
    ...
    const conteos = {};
    const conteosEfectividad = {}; // Nuevo contador
    let totalCitas = 0;
    ...
    datosTabla.forEach(fila => {
        if (fila.id_cit) {
            ...
            // Contar efectividad solo si tiene un valor seteado
    ...
    // 1. Dibujar pastillas de ESTATUS
    ...
    // 2. Dibujar pastillas de EFECTIVIDAD 
